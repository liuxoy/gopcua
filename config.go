...
// DisableNamespaceInit disables the automatic update of the global
// node id parser with the server namespaces on connect.
func DisableNamespaceInit() Option {
	return func(cfg *Config) {
		cfg.disableNSInit = true
	}
}
